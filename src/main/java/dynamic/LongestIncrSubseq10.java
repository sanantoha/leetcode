...
public class LongestIncrSubseq10 {
    ...
    public static List<Integer> lisList(int[] arr) {
        ...
        return buildResult(arr, prev, maxIdx);
    }

    private static List<Integer> buildResult(int[] arr, int[] prev, int maxIdx) {
        int idx = maxIdx;
        List<Integer> res = new ArrayList<>();
    ...
    public static List<Integer> lisList0(int[] arr) {
        ...
        return buildResult(arr, prev, indices[length]);
    }
