...
public class LongestDecrSubseq8 {
    ...
    private static List<Integer> buildList(int[] arr, int[] prev, int idx) {
    ...
    public static List<Integer> ldsList1(int[] arr) {
        if (arr == null || arr.length == 0) Collections.emptyList();
