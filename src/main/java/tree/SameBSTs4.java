...
public class SameBSTs4 {
    ...
    // O((a1 + a2) ^ 2)) time | O((a1 + a2) ^ 2)) space
    ...
    private static boolean areSameBsts(
        ...
        return areSameBsts(arrayOne, arrayTwo, lessIdxOne, lessIdxTwo, minVal, val) &&
                areSameBsts(arrayOne, arrayTwo, greaterOrEqualIdxOne, greaterOrEqualIdxTwo, val, maxVal);
    }
